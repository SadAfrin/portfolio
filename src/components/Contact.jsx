          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-10 lg:p-16 bg-brand-accent/5">
              ...
              <div className="space-y-8">
                {[
                  { label: "Email", value: "[Email Pending]", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", color: "brand-accent", href: "mailto:your-email@example.com" },
                  ...
                  { label: "Location", value: "[Location Pending]", icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z", color: "white/50" }
                ].map((item, index) => (
                  <motion.div 
                    key={index}
                    whileHover={{ x: 10 }}
